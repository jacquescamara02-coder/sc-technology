import { S as reactExports, F as isPromise, G as isRedirect, E as isNotFound, A as invariant, g as createControlledPromise, _ as rootRouteId, H as isServer$1, u as functionalUpdate$1, b as arraysEqual, h as createLRUCache, e as compileDecodeCharMap, a0 as trimPath, Z as rewriteBasepath, f as composeRewrites, Q as processRouteTree, P as processRouteMasks, Y as resolvePath, d as cleanPath, a2 as trimPathRight, N as parseHref, p as executeRewriteInput, B as isDangerousProtocol, T as redirect, t as findSingleMatch, k as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, z as interpolatePath, M as nullReplaceEqualDeep, V as replaceEqualDeep$1, K as last, j as decodePath, r as findFlatMatch, s as findRouteMatch, y as hasKeys, q as executeRewriteOutput, m as encodePathLikeUrl, a1 as trimPathLeft, I as joinPaths, a5 as useRouter, l as dummyMatchContext, L as matchContext, w as getDefaultExportFromCjs, W as requireReactDom, o as exactPathTest, U as removeTrailingSlash, R as React, J as jsxRuntimeExports, C as isModuleNotFoundError, a3 as useHydrated, n as escapeHtml, v as getAssetCrossOrigin, x as getScriptPreloadAttrs, a as appendUniqueUserTags, X as resolveManifestCssLink, O as Outlet } from "./server-DZhSK7L0.js";
...
var Route$v = class Route extends BaseRoute {
  /**
...
const appCss = "/assets/styles-D16Da99J.css";
...
const Cable = createLucideIcon("cable", __iconNode$g);
const __iconNode$f = [
...
const Laptop = createLucideIcon("laptop", __iconNode$b);
const __iconNode$a = [
...
const logoUrl = "/assets/sc-logo-DK1-JFoP.png";
function Logo({
  compact = false,
  variant = "dark"
}) {
  const bg = variant === "light" ? "bg-white" : "bg-white/95 shadow-[var(--shadow-glow)]";
    ...
    (set, get) => ({
      ...
      add: (p, qty = 1) => set((s) => {
        ...
        if (existing) {
          return {
            items: s.items.map(
              (i) => i.product.id === p.id ? { ...i, qty: i.qty + qty } : i
            )
          };
        }
...
function TopHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-screen-md items-center gap-3 px-4 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/search", className: "relative flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-full items-center rounded-full border border-border bg-surface pl-9 pr-3 text-sm text-muted-foreground", children: "Rechercher un produit..." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          ...
          count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-0.5 -top-0.5 grid h-5 min-w-5 place-items-center rounded-full bg-primary px-1 text-[10px] font-bold text-primary-foreground shadow-[var(--shadow-glow)]", children: count })
        ]
      }
    )
  ] }) });
...
function BottomNav() {
  const count = useCart((s) => s.items.reduce((a, i) => a + i.qty, 0));
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed inset-x-0 bottom-0 z-40 border-t border-border/60 bg-background/90 backdrop-blur-xl pb-[env(safe-area-inset-bottom)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mx-auto flex max-w-screen-md items-stretch justify-around px-2 py-1.5", children: tabs.map((t) => {
    const Icon2 = t.icon;
      ...
      Link,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5", strokeWidth: 2.25 }),
            t.to === "/panier" && count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-2 -top-1.5 grid h-4 min-w-4 place-items-center rounded-full bg-primary px-1 text-[9px] font-bold text-primary-foreground", children: count })
          ] }),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative mx-auto mt-8 max-w-screen-md px-4 pb-8 pt-6 text-center text-xs text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 rounded-3xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] font-semibold uppercase tracking-[0.2em] text-primary/90", children: "Bientôt disponible" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-base font-bold text-foreground", children: "SC TECHNOLOGIE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-muted-foreground", children: "Téléchargez l'application mobile officielle" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex flex-wrap items-center justify-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StoreBadge, { store: "google" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StoreBadge, { store: "apple" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/60 pt-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground", children: "SC TECHNOLOGIE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex flex-wrap items-center justify-center gap-x-4 gap-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+224620212045", className: "inline-flex items-center gap-1.5 hover:text-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3.5 w-3.5 text-primary" }),
          " 620-21-20-45"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+224610953838", className: "inline-flex items-center gap-1.5 hover:text-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3.5 w-3.5 text-primary" }),
          " 610-95-38-38"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-3.5 w-3.5 text-[#25D366]" }),
              " WhatsApp : 620-21-20-45"
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 text-[11px]", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " SC TECHNOLOGIE • Guinée"
      ] })
    ] })
  ] });
}
function StoreBadge({ store }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        isApple ? /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", className: "h-7 w-7", fill: "currentColor", "aria-hidden": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16.365 1.43c0 1.14-.42 2.22-1.11 3.03-.75.87-1.96 1.55-3.13 1.46-.13-1.12.41-2.27 1.07-3.02.74-.86 2-1.51 3.17-1.47zM20.5 17.27c-.57 1.31-.84 1.89-1.57 3.05-1.02 1.61-2.46 3.62-4.24 3.64-1.58.02-1.99-1.03-4.13-1.02-2.14.01-2.59 1.04-4.17 1.02-1.78-.02-3.14-1.83-4.16-3.44C-.6 16.95-.92 11.6 1.04 8.7c1.39-2.07 3.57-3.28 5.62-3.28 2.09 0 3.4 1.14 5.13 1.14 1.68 0 2.7-1.14 5.12-1.14 1.83 0 3.77 1 5.16 2.72-4.53 2.48-3.79 8.96-1.57 9.13z" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 48 48", className: "h-7 w-7", "aria-hidden": true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#34A853", d: "M6.5 6.5l21.3 21.3-5.4 5.4L6.5 17.3z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FBBC04", d: "M33.4 22.1l-5.6-5.6L6.5 6.5l16.9 16.9z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#EA4335", d: "M6.5 41.5l21.3-21.3 5.6 5.6L6.5 41.5z" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#4285F4", d: "M40.5 21.2l-7.1-4.1-5.6 5.6 5.4 5.4 7.3-4.2c1.6-.9 1.6-3.8 0-2.7z" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] opacity-80", children: isApple ? "Télécharger dans l'" : "Disponible sur" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tracking-tight", children: isApple ? "App Store" : "Google Play" })
        ] })
      ]
    }
  );
...
function AmbientBackground() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_top,oklch(0.24_0.08_265)_0%,oklch(0.16_0.04_260)_45%,oklch(0.12_0.03_260)_100%)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ambient-blob ambient-blob-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ambient-blob ambient-blob-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ambient-blob ambient-blob-3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 left-1/2 h-[420px] w-[820px] -translate-x-1/2 rounded-full bg-[radial-gradient(closest-side,oklch(0.65_0.22_265/0.35),transparent_70%)] blur-2xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-72 bg-gradient-to-t from-[oklch(0.10_0.03_265)]/80 to-transparent" })
      ]
    }
  );
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Page introuvable." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "mt-6 inline-flex rounded-full bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground", children: "Retour à l'accueil" })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-foreground", children: "Une erreur est survenue" }),
...
function RootComponent() {
  ...
  if (isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeApplier, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-slate-50 text-slate-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeApplier, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 min-h-screen pb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TopHeader, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto max-w-screen-md animate-[fade-in_0.3s_ease-out]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, {})
    ] })
  ] });
}
const $$splitComponentImporter$s = () => import("./vedette-D86AUETI.js");
const Route$t = createFileRoute("/vedette")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./search-Bb7KzQZi.js");
const Route$s = createFileRoute("/search")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./profil-BWIle_kC.js");
const Route$r = createFileRoute("/profil")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const useProfile = create()(persist((set) => ({
  fullName: "RDIALLO",
  ...
  name: "sc-profile",
  storage: createJSONStorage(() => typeof window !== "undefined" ? window.localStorage : void 0)
}));
const $$splitComponentImporter$p = () => import("./panier-DhmC_T-W.js");
const Route$q = createFileRoute("/panier")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./orders-DVvh6KQ0.js");
const Route$p = createFileRoute("/orders")({
...
ZodOptional.create;
ZodNullable.create;
const $$splitComponentImporter$n = () => import("./order-success-DOZOedaN.js");
const searchSchema = objectType({
  id: stringType().optional()
});
const Route$o = createFileRoute("/order-success")({
  validateSearch: searchSchema,
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./nouveautes-DZ2a7zxq.js");
const Route$n = createFileRoute("/nouveautes")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./checkout-C7lVQFDU.js");
const Route$m = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./categories-B2jlh2Pu.js");
const Route$l = createFileRoute("/categories")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./cart-CXWPrZN1.js");
const Route$k = createFileRoute("/cart")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./admin-CRepObyp.js");
const Route$j = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./index-B6KHBa3z.js");
const Route$i = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const img = (hue) => `linear-gradient(135deg, oklch(0.42 0.18 ${hue}), oklch(0.28 0.10 ${hue + 30}))`;
const catDefs = [
  {
    id: "laptops",
    name: "Laptops",
...
for (const c of catDefs) {
  for (const sub of c.subcategories) {
    ...
    for (let i = 0; i < 22; i++) {
      ...
      const badge = badgeIdx === 0 ? "Promo" : badgeIdx === 1 ? "Nouveau" : badgeIdx === 2 ? "Top" : void 0;
      const oldPrice = badge === "Promo" ? Math.round(price * 1.2 / 5e4) * 5e4 : void 0;
      productsAll.push({
        id: `${c.id}-${sub.id}-${i + 1}`,
        ...
        createdAt: now - i * 864e5 - c.hue * 1e3,
        badge,
...
[...productsAll].sort((a, b) => b.popularity - a.popularity);
[...productsAll].sort((a, b) => b.createdAt - a.createdAt);
...
const productImages = (p) => {
  ...
  return [0, 25, -20, 60].map(
    (off, i) => img(baseHue + off + (seed + i * 13) % 30 - 15)
  );
};
...
const ADMIN_EMAIL = "admin@techshopgn.com";
...
const defaultSettings = {
  ...
  tiktokUrl: "",
  deliveryFees: [
    { city: "Conakry", fee: 5e4 },
    { city: "Labé", fee: 15e4 },
    { city: "Kankan", fee: 18e4 },
    { city: "N'Zérékoré", fee: 2e5 },
    { city: "Kindia", fee: 1e5 },
    { city: "Faranah", fee: 17e4 },
    { city: "Mamou", fee: 13e4 },
    { city: "Siguiri", fee: 19e4 },
    { city: "Boké", fee: 14e4 },
    { city: "Coyah", fee: 8e4 }
  ],
  freeShippingThreshold: 5e6,
  vatRate: 0.18,
  facebookPageId: "",
  facebookToken: "",
...
const useAdminData = create()(
  persist(
    (set) => ({
      ...
      bulkUpdate: (ids, patch) => set((s) => ({
        products: s.products.map((p) => ids.includes(p.id) ? { ...p, ...patch } : p)
      })),
      bulkDelete: (ids) => set((s) => ({ products: s.products.filter((p) => !ids.includes(p.id)) })),
      addCategory: (name, iconKey) => set((s) => ({
        categories: [
          ...s.categories,
      ...
      addSubcategory: (catId, name) => set((s) => ({
      ...
      updateSubcategory: (catId, subId, name) => set((s) => ({
        categories: s.categories.map(
          (c) => c.id === catId ? {
            ...c,
            subcategories: c.subcategories.map(
              (sc) => sc.id === subId ? { ...sc, name } : sc
            )
          } : c
        )
      })),
      deleteSubcategory: (catId, subId) => set((s) => ({
        categories: s.categories.map(
          (c) => c.id === catId ? { ...c, subcategories: c.subcategories.filter((sc) => sc.id !== subId) } : c
        )
      })),
      updateSettings: (patch) => set((s) => ({ settings: { ...s.settings, ...patch } })),
      addHeroSlide: (slide) => set((s) => ({
        settings: {
          ...s.settings,
          heroSlides: [
      ...
      updateHeroSlide: (id, patch) => set((s) => ({
        settings: {
          ...s.settings,
          heroSlides: s.settings.heroSlides.map(
            (h) => h.id === id ? { ...h, ...patch } : h
          )
        }
      })),
      deleteHeroSlide: (id) => set((s) => ({
        settings: {
          ...s.settings,
          heroSlides: s.settings.heroSlides.filter((h) => h.id !== id)
        }
      })),
      moveHeroSlide: (id, dir) => set((s) => {
      ...
      recordFacebookPost: (post) => set((s) => {
        ...
        return {
          ...
          products: s.products.map(
            (p) => p.id === post.productId ? { ...p, facebookPostedAt: post.date, facebookStatus: post.status } : p
          )
        };
      }),
      resetAll: () => set({
      ...
      migrate: (persisted, version) => {
        ...
        if (version < 4) {
          data.settings = {
            ...
            storeName: "SC TECHNOLOGIE",
            facebookUrl: data.settings?.facebookUrl?.includes("fb.me/8TeLA81zv") ? data.settings.facebookUrl : "https://fb.me/8TeLA81zv",
            heroSlides: defaultHeroSlides
          };
        }
        return data;
...
const $$splitComponentImporter$g = () => import("./product._productId-CdI0MoEq.js");
const Route$g = createFileRoute("/product/$productId")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./orders._orderId-DlXBoJFD.js");
const Route$f = createFileRoute("/orders/$orderId")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./checkout_.payment-CgPi6Qty.js");
const Route$e = createFileRoute("/checkout_/payment")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./categories._categoryId-CpZUmrba.js");
const Route$d = createFileRoute("/categories/$categoryId")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./admin.settings-BF_LbWnc.js");
const Route$c = createFileRoute("/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./admin.products-DGWPm6ZQ.js");
const Route$b = createFileRoute("/admin/products")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./admin.orders-j5hQ6ni3.js");
const Route$a = createFileRoute("/admin/orders")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./admin.login-Clp0aZq5.js");
const Route$9 = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./admin.invoice-BoNzpWdN.js");
const Route$8 = createFileRoute("/admin/invoice")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./admin.facebook-0x4Td8lZ.js");
const Route$7 = createFileRoute("/admin/facebook")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./admin.dashboard-BxxEWeUy.js");
const Route$6 = createFileRoute("/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin.categories-CXK8tJ5P.js");
const Route$5 = createFileRoute("/admin/categories")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin.banners-DS_5TeT1.js");
const Route$4 = createFileRoute("/admin/banners")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./categories._categoryId._subCategoryId-en9GAR_X.js");
const Route$3 = createFileRoute("/categories/$categoryId/$subCategoryId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.products.new-BZjMFX-V.js");
const Route$2 = createFileRoute("/admin/products/new")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.products._productId.facebook-preview-DcaAtsFb.js");
const Route$1 = createFileRoute("/admin/products/$productId/facebook-preview")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.products._productId.edit-DyqAD4hj.js");
const Route2 = createFileRoute("/admin/products/$productId/edit")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const VedetteRoute = Route$t.update({
  id: "/vedette",
  path: "/vedette",
  getParentRoute: () => Route$u
});
const SearchRoute = Route$s.update({
  id: "/search",
  path: "/search",
  getParentRoute: () => Route$u
});
const ProfilRoute = Route$r.update({
  id: "/profil",
  path: "/profil",
  getParentRoute: () => Route$u
});
const PanierRoute = Route$q.update({
  id: "/panier",
  path: "/panier",
  getParentRoute: () => Route$u
});
const OrdersRoute = Route$p.update({
  id: "/orders",
  path: "/orders",
  getParentRoute: () => Route$u
});
const OrderSuccessRoute = Route$o.update({
  id: "/order-success",
  path: "/order-success",
  getParentRoute: () => Route$u
});
const NouveautesRoute = Route$n.update({
  id: "/nouveautes",
  path: "/nouveautes",
  getParentRoute: () => Route$u
});
const CheckoutRoute = Route$m.update({
  id: "/checkout",
  path: "/checkout",
  getParentRoute: () => Route$u
});
const CategoriesRoute = Route$l.update({
  id: "/categories",
  path: "/categories",
  getParentRoute: () => Route$u
});
const CartRoute = Route$k.update({
  id: "/cart",
  path: "/cart",
  getParentRoute: () => Route$u
});
...
const ProductProductIdRoute = Route$g.update({
  id: "/product/$productId",
  path: "/product/$productId",
  getParentRoute: () => Route$u
});
const OrdersOrderIdRoute = Route$f.update({
  id: "/$orderId",
  path: "/$orderId",
  getParentRoute: () => OrdersRoute
});
const CheckoutPaymentRoute = Route$e.update({
  id: "/checkout_/payment",
  path: "/checkout/payment",
  getParentRoute: () => Route$u
});
const CategoriesCategoryIdRoute = Route$d.update({
  id: "/$categoryId",
  path: "/$categoryId",
...
const AdminProductsRoute = Route$b.update({
  id: "/products",
  path: "/products",
  getParentRoute: () => AdminRoute
});
const AdminOrdersRoute = Route$a.update({
  id: "/orders",
  path: "/orders",
  getParentRoute: () => AdminRoute
});
const AdminLoginRoute = Route$9.update({
  id: "/login",
  path: "/login",
  getParentRoute: () => AdminRoute
});
const AdminInvoiceRoute = Route$8.update({
  id: "/invoice",
  path: "/invoice",
  getParentRoute: () => AdminRoute
});
const AdminFacebookRoute = Route$7.update({
  id: "/facebook",
  path: "/facebook",
  getParentRoute: () => AdminRoute
});
...
const AdminCategoriesRoute = Route$5.update({
  id: "/categories",
  path: "/categories",
  getParentRoute: () => AdminRoute
});
const AdminBannersRoute = Route$4.update({
  id: "/banners",
  path: "/banners",
  getParentRoute: () => AdminRoute
});
const CategoriesCategoryIdSubCategoryIdRoute = Route$3.update({
  id: "/$subCategoryId",
  path: "/$subCategoryId",
...
const AdminProductsProductIdFacebookPreviewRoute = Route$1.update({
  id: "/$productId/facebook-preview",
  path: "/$productId/facebook-preview",
  getParentRoute: () => AdminProductsRoute
});
const AdminProductsProductIdEditRoute = Route2.update({
  id: "/$productId/edit",
  path: "/$productId/edit",
  getParentRoute: () => AdminProductsRoute
});
const AdminProductsRouteChildren = {
  ...
  AdminProductsProductIdEditRoute,
...
const CategoriesCategoryIdRouteChildren = {
  CategoriesCategoryIdSubCategoryIdRoute
};
const CategoriesCategoryIdRouteWithChildren = CategoriesCategoryIdRoute._addFileChildren(CategoriesCategoryIdRouteChildren);
...
export {
  ...
  averageRating as q,
  create as r,
  createJSONStorage as s,
  createLucideIcon as t,
  formatGNF as u,
  generateProductId as v,
  logoUrl as w,
  persist as x,
  productImages as y,
  productReviews as z
